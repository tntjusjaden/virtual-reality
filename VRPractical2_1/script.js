...
*/
 function createCloud(x, y, z){
  ...
  cloud1.setAttribute("color","gray");
  cloud1.setAttribute("position","0 6 0");
  cloud1.setAttribute("radius","2");
  cloud.append( cloud1 );

  let cloud2 = document.createElement("a-cylinder");
  cloud2.setAttribute("position","1 6 0");
  cloud2.setAttribute("color","white");
  cloud2.setAttribute("radius","0.25");
  cloud.append( cloud2 );
